...
printf $fh "};\n\n";
printf $fh "static const std::array<struct msgtable, 82> msgtable = {{\n";
...
printf $fh "}};\n\n";
printf $fh "static const std::array<struct msgtable, 9> cdcmsgtable = {{\n";
printf $fh "%s", $cdcmsgtable;
printf $fh "}};\n\n";
printf $fh "static const std::array<struct msgtable, 49> htngmsgtable = {{\n";
