...
static const std::array<remote_test, 20> tests{
	remote_test{ "Core", TAG_CORE, core_subtests },
	remote_test{ "Give Device Power Status feature", TAG_POWER_STATUS, power_status_subtests },
	remote_test{ "System Information feature", TAG_SYSTEM_INFORMATION, system_info_subtests },
	remote_test{ "Vendor Specific Commands feature", TAG_VENDOR_SPECIFIC_COMMANDS, vendor_specific_subtests },
	remote_test{ "Device OSD Transfer feature", TAG_DEVICE_OSD_TRANSFER, device_osd_transfer_subtests },
	remote_test{ "OSD String feature", TAG_OSD_DISPLAY, osd_string_subtests },
	remote_test{ "Remote Control Passthrough feature", TAG_REMOTE_CONTROL_PASSTHROUGH, rc_passthrough_subtests },
	remote_test{ "Device Menu Control feature", TAG_DEVICE_MENU_CONTROL, dev_menu_ctl_subtests },
	remote_test{ "Deck Control feature", TAG_DECK_CONTROL, deck_ctl_subtests },
	remote_test{ "Tuner Control feature", TAG_TUNER_CONTROL, tuner_ctl_subtests },
	remote_test{ "One Touch Record feature", TAG_ONE_TOUCH_RECORD, one_touch_rec_subtests },
	remote_test{ "Timer Programming feature", TAG_TIMER_PROGRAMMING, timer_prog_subtests },
	remote_test{ "Capability Discovery and Control feature", TAG_CAP_DISCOVERY_CONTROL, cdc_subtests },
	remote_test{ "Dynamic Auto Lipsync feature", TAG_DYNAMIC_AUTO_LIPSYNC, dal_subtests },
	remote_test{ "Audio Return Channel feature", TAG_ARC_CONTROL, arc_subtests },
	remote_test{ "System Audio Control feature", TAG_SYSTEM_AUDIO_CONTROL, sac_subtests },
	remote_test{ "Audio Rate Control feature", TAG_AUDIO_RATE_CONTROL, audio_rate_ctl_subtests },
	remote_test{ "Routing Control feature", TAG_ROUTING_CONTROL, routing_control_subtests },
	remote_test{ "Standby/Resume and Power Status", TAG_POWER_STATUS | TAG_STANDBY_RESUME, standby_resume_subtests },
	remote_test{ "Post-test checks", TAG_CORE, post_test_subtests },
};
